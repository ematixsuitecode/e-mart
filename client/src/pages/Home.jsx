...
const EngagementBanner = () => {
  return (
    <div className="w-full py-14 relative">
      {/* ----------- Background Effects (Soft Glow + Gradient) ------------ */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#f8f6ff] to-white pointer-events-none" />
      <div className="absolute top-10 left-10 w-40 h-40 bg-purple-200 rounded-full blur-3xl opacity-30 pointer-events-none animate-pulse" />
      <div className="absolute bottom-10 right-20 w-48 h-48 bg-yellow-200 rounded-full blur-3xl opacity-25 pointer-events-none animate-pulse" />
      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 text-sm mt-2">
            Grab these exclusive offers before they disappear!
          </p>
        </div>

        {/* Cards Row */}
        <div className="flex gap-8 overflow-x-auto hide-scrollbar pb-6 justify-center">
          {/* ------------------------- 99 STORE ------------------------- */}
          <Link
            to="/99store"
            className="min-w-[280px] h-[150px] relative rounded-2xl overflow-hidden
              bg-gradient-to-br from-yellow-300 via-orange-400 to-red-400 shadow-lg
              transition-transform transform hover:-translate-y-2 hover:shadow-2xl
              hover:scale-[1.02] duration-300 cursor-pointer"
          >
            {/* Glow */}
            <div className="absolute inset-0 opacity-40 bg-[radial-gradient(circle_at_top_right,white,transparent)]" />
            ...
            <div className="absolute inset-0 flex items-center justify-between px-6">
              ...
              <Zap className="w-20 h-20 text-white opacity-70 drop-shadow-xl" />
            </div>
          </Link>
          ...
          >
            {/* Floating Glow */}
            <div className="absolute inset-0 bg-[radial-gradient(circle,rgba(255,255,255,0.3),transparent)] animate-pulse"></div>
            ...
            <div className="absolute inset-0 flex items-center justify-between px-6">
              <div className="flex flex-col text-white">
                ...
                <span className="text-xs opacity-90">Exciting gifts await</span>
              </div>

              <Gift className="w-20 h-20 text-white animate-bounce drop-shadow-xl" />
            </div>
          </Link>
          ...
          <Link
            to="/todays-special"
            className="min-w-[280px] h-[150px] relative rounded-2xl overflow-hidden
              bg-gradient-to-br from-blue-400 via-indigo-500 to-blue-700 shadow-lg
              transition-transform transform hover:-translate-y-2 hover:shadow-2xl
              hover:scale-[1.02] duration-300 cursor-pointer"
          >
            {/* Shine effect */}
            <div className="absolute inset-0 bg-[linear-gradient(110deg,rgba(255,255,255,0.2),rgba(255,255,255,0.05),transparent)] animate-[pulse_3s_infinite]" />
            ...
            <div className="absolute inset-0 flex items-center justify-between px-6">
              <div className="flex flex-col text-white">
                ...
                <h3 className="text-4xl font-extrabold drop-shadow">Coupons</h3>
                <span className="text-xs opacity-90">Save more today</span>
              </div>

              <Ticket className="w-20 h-20 text-white opacity-90 drop-shadow-xl" />
            </div>
          </Link>
        </div>
      </div>
...
const DealZone = () => {
  ...
  return (
    <section className="relative z-20 mt-10 mb-10">
      ...
      <div className="absolute -top-10 -left-10 w-40 h-40 bg-purple-300 blur-3xl opacity-20 pointer-events-none"></div>
      <div className="absolute bottom-0 right-0 w-52 h-52 bg-indigo-300 blur-2xl opacity-20 pointer-events-none"></div>

      <div className="relative container mx-auto px-4">
        <div className="backdrop-blur-xl bg-white/70 rounded-2xl shadow-xl border overflow-hidden p-6 md:p-8">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-center">
            {/* ----------------------------------------------------------------
                LEFT PANEL — Countdown
            ---------------------------------------------------------------- */}
            <div className="lg:col-span-1 border-b lg:border-b-0 lg:border-r border-gray-200/40 pb-6 lg:pb-0 pr-0 lg:pr-8">
              <div className="flex items-center gap-2 mb-2">
                <Clock className="w-5 h-5 text-rose-500 animate-pulse" />
                <h3 className="text-lg md:text-xl font-extrabold text-gray-800 tracking-tight">
                  DEAL OF THE DAY
                </h3>
              </div>
              ...
              <div className="flex gap-4">
                {["04", "32", "15"].map((t, i) => (
                  ...
                  >
                    <div className="relative bg-gray-900 text-white rounded-xl w-12 h-12 flex items-center justify-center shadow-lg">
                      <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-white/10 to-transparent"></div>
                      <span className="text-xl font-black font-mono">{t}</span>
                    </div>
            ...
            {/* ----------------------------------------------------------------
                RIGHT PANEL — Marquee Product Slider
            ---------------------------------------------------------------- */}
            <div className="lg:col-span-3 relative overflow-hidden py-3">
              ...
              <div className="flex gap-6 whitespace-nowrap animate-marquee hover:[animation-play-state:paused]">
                {[...dealProducts, ...dealProducts].map((product, index) => (
                  <Link
                    key={product.id + "-m-" + index}
                    to={`/products/${product.id}`}
                    className="inline-flex min-w-[240px] bg-white/80 backdrop-blur-md p-4 rounded-xl border border-gray-200 
                               shadow-md hover:shadow-xl hover:scale-[1.015] transition-all cursor-pointer relative"
                  >
                    <img
                      src={product.image}
                      className="w-20 h-20 object-contain mix-blend-multiply transform group-hover:scale-110 transition duration-500"
                      alt={product.name}
                    />

                    <div className="flex flex-col ml-3">
                      <span className="bg-rose-100 text-rose-600 text-[10px] font-bold px-2 py-0.5 rounded-full w-max mb-1 animate-pulse">
                        HOT DEAL
                      </span>
