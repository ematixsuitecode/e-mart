  ...
  return (
    <header className="sticky top-0 z-50 bg-white font-sans shadow-lg transition-all duration-300">
      ...
      <div className="bg-white py-3 px-4 md:px-8 flex items-center gap-4 md:gap-8 relative">
        ...
        {/* Location */}
        <div className="hidden lg:flex flex-col leading-tight cursor-pointer hover:bg-gray-50 p-2 
        ...
        <div className="flex-1 max-w-2xl relative z-20">
          <div className="relative group">
            ...
            <button className="absolute right-2 top-1.5 bg-indigo-50 text-indigo-600 
        ...
        <div className="flex items-center gap-3 md:gap-6 text-gray-600 ml-auto md:ml-0">
          ...
          {/* Profile */}
          <Link to="/profile" className="hidden md:flex flex-col items-center p-2 hover:bg-indigo-50">
            <User className="w-6 h-6" />
            <span className="text-[10px] font-bold">Profile</span>
          </Link>

          {/* Wishlist */}
          <Link to="/wishlist" className="hidden md:flex flex-col items-center p-2 hover:bg-rose-50 relative">
          ...
          {/* Cart */}
          <Link to="/cart" className="flex flex-col items-center p-2 hover:bg-gray-100 relative">
            <ShoppingCart className="w-6 h-6" />
            <span className="text-[10px] font-bold">Cart</span>
            <span className="absolute -top-0.5 right-0.5 bg-yellow-400 text-indigo-900 
