          ...
          <div className="space-y-4">
            <div className="flex items-center gap-1.5 mb-4">
              <span className="text-2xl font-black tracking-tighter text-white">
                EMART<span className="text-indigo-500">MARKET</span>
              </span>
            </div>
            <p className="text-sm text-gray-400 leading-relaxed mb-4">
              The ultimate shopping destination for fashion, electronics, and
              home essentials. Quality products delivered at lightning speed.
            </p>
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-indigo-500 shrink-0 mt-0.5" />
                <span>
                  123 Commerce Avenue, Tech Park,
                  <br />
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  href="mailto:support@ematixmarket.com"
                  className="hover:text-white transition-colors"
                >
                  support@ematixmarket.com
                </a>
              </div>
              <div className="flex items-center gap-3">
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              <a
                href="#"
                className="bg-gray-800 p-2 rounded-full hover:bg-indigo-600 hover:text-white transition-all"
              >
                <Facebook className="w-4 h-4" />
              </a>
              <a
                href="#"
                className="bg-gray-800 p-2 rounded-full hover:bg-pink-600 hover:text-white transition-all"
              >
                <Instagram className="w-4 h-4" />
              </a>
              <a
                href="#"
                className="bg-gray-800 p-2 rounded-full hover:bg-blue-400 hover:text-white transition-all"
              >
                <Twitter className="w-4 h-4" />
              </a>
              <a
                href="#"
                className="bg-gray-800 p-2 rounded-full hover:bg-red-600 hover:text-white transition-all"
              >
            ...
            <div className="text-xs text-gray-500 text-center">
              &copy; {new Date().getFullYear()} EmatixMarket Inc. All rights
              reserved.
            </div>
